            ...
            <div class="cta-inner text-center rounded">
              ...
              <ul class="list-unstyled list-hours mb-5 text-left mx-auto">
                <li class="list-unstyled-item list-hours-item d-flex">
                  Domingo
                  <span class="ml-auto">Oficina Cerrada</span>
                </li>
                <li class="list-unstyled-item list-hours-item d-flex">
                  Lunes
                ...
                <li class="list-unstyled-item list-hours-item d-flex">Sábado
                  
                  <span class="ml-auto">9:00 AM a 2:00 PM</span>
                </li>
                <li class="list-unstyled-item list-hours-item d-flex">
                  Jueves 
                  <span class="ml-auto">9:00 AM a 6:00 PM</span>
              ...
              <p class="address mb-5">
                <em>
                  <strong>Antonio Alzate Col. Centro #110</strong>
                  <br>
                  Morelia, Michoacán
                </em>
              </p>
            ...
            <div class="col-xl-9 col-lg-10 mx-auto">
              <div class="bg-faded rounded p-5">
                <h2 class="section-heading mb-4">
                  <span class="section-heading-lower">A CERCA DE NOSOTROS</span><h2>PANDEMIX VIRTUAL TOUR</h2>
                </h2>
               Nuestro empresa nace de un proyecto escolar, del cual la temática trata de dar solución a la problemática de la pandemia, y la afectación de los negocios físicos donde se requiere público presente, tal es el caso de los museos 🏛 
              </div>
            </div>
          </div>
        </div>
